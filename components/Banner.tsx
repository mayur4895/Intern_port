...
const Banner = () => {
  ...
  <h1 className='md:text-6xl  md:max-w-screen-md sm:max-w-screen-sm  m-auto  sm:2xl text-xl font-bold  text-zinc-600'>Search,Apply & Get Your <span className='text-blue-500'>Dream</span> Job.</h1>
